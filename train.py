...
# Entraîner le modèle
model.train(
    data='C:/Users/HP ELITEBOOK 840/Downloads/Annotation-Factures 2.v1i.yolov8 (2)/data.yaml',  # Chemin vers le fichier YAML
    epochs=150,                # Nombre d'époques
    imgsz=640,                 # Taille des images
    batch=16,                  # Taille du batch
    name='invoice_yolov8_new_train_2',     # Nom du projet
